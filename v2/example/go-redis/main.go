...
import (
	...
	"github.com/lukst0ne/machinery/v2/log"
	"github.com/lukst0ne/machinery/v2/tasks"

	redisbackend "github.com/lukst0ne/machinery/v2/backends/redis"
	redisbroker "github.com/lukst0ne/machinery/v2/brokers/redis"
	exampletasks "github.com/lukst0ne/machinery/v2/example/tasks"
	"github.com/lukst0ne/machinery/v2/example/tracers"
	eagerlock "github.com/lukst0ne/machinery/v2/locks/eager"
